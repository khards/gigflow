 ...
 * Class Address.
 *
 * Parse customer address from user submitted form details
 * See config: checkout.customer_address_details_form
 */
class Address
{
    ...
    {
        $requiredFormName = config('checkout.customer_address_details_form.name');
        ...
        $requiredFormItems = config('checkout.customer_address_details_form.items');
