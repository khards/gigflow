                ...
                <x-frontend.card>
                    ...
                    <x-slot name="body">
                        <x-forms.post :action="route('frontend.auth.register')">
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label">@lang('E-mail Address')</label>
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label">@lang('Password')</label>
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label">@lang('Password Confirmation')</label>
