<x-forms.patch :action="route('frontend.user.calendar.update')">
    <div class="form-group row">
        <label for="calendar_url" class="col-md-3 col-form-label">@lang('Incoming Calendar URL (Holiday)')</label>
    ...
    <div class="form-group row">
        <label for="calendar_schedule_url" class="col-md-3 col-form-label">@lang('Incoming Calendar URL (Schedule)')</label>
    ...
    <div class="form-group row">
        <label for="outgoing_calendar_url" class="col-md-3 col-form-label">@lang('Outgoing Calendar URL')</label>
        <?php
