                    ...
                    <x-slot name="body">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <x-utils.link
                                    :text="__('Calendar Integration')"
                                    class="nav-link"
                                    id="calendar-integration-tab"
                                    data-toggle="pill"
                                    href="#calendar-integration"
                                    role="tab"
                                    aria-controls="calendar-integration"
                                    aria-selected="false"/>
                        ...
                        <div class="tab-content" id="my-profile-tabsContent">
                            ...
                            <div class="tab-pane fade pt-3" id="calendar-integration" role="tabpanel" aria-labelledby="calendar-integration-tab">
                                @include('frontend.user.account.tabs.calendar-integration')
                            </div>
